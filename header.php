<header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">=
        <div class="navbar-header">
            <a class="navbar-brand active" href="/codigo/Tarea1Expertos/index.php">Tarea 1</a>
        </div>
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item"><a class="nav-link" href="/codigo/Tarea1Expertos/src/formTarea1.php">Estilo de aprendizaje</a></li>
                <li class="nav-item"><a class="nav-link" href="/codigo/Tarea1Expertos/src/formRecinto.php">Recinto de origen</a></li>
